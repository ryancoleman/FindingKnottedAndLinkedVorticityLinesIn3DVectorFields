...
//this version outputs multiple components!
//without overlaps or repeats

//USAGE:::::
//
// testmnr <inputfile> <outputfile> [<maxAlpha> <numComponents>]
// 
// the first two are required filenames
// the second two are optional, first is float, second is integer
// maxAlpha defaults to 1.1 numComponents defaults to 5
...
int numComponents = 5; //can be set in fourth input parameter
...
struct Node
  ...
  int dead;  //used to mark as dead, i.e. don't output any cycle containing this again
             //0 -> good :: 1 -> bad
  Edge *edge;
  };
