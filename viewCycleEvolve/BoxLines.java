...
public class BoxLines extends Shape3D
  {

  public BoxLines(Link[] pointArrays) 
    {
    super();
    ...
    app.setPolygonAttributes(new PolygonAttributes(PolygonAttributes.POLYGON_LINE, PolygonAttributes.CULL_NONE, 0.0f));
